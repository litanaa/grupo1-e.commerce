...
<html lang="en" dir="ltr">
  ...
  <div class="row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" id="Telefono" placeholder="Telefono" name="Telefono" value="<?=$telefono?>">
    </div>
  </div>
  <div class="form-group"class="col -xs-12 col-md-6 col-lg-4s" style="width: 32rem;" >
    <label for="inputNombre">Nombre y Apellido</label>
    <input type="text" class="form-control" id="nombre" placeholder="Manyula" name="nombre" value="<?=$nombre?>">
  </div>
  ...
  <div class="form-group"class="col -xs-12 col-md-6 col-lg-4s" style="width: 32rem;">
    ...
    <input type="text" class="form-control" id="address" placeholder="Av. Siempre viva 742" name="address" value="<?=$address?>">
  </div>
